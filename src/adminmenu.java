...
public class adminmenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        delete_student.setBackground(new java.awt.Color(153, 0, 0));
        ...
        show_student.setBackground(new java.awt.Color(0, 0, 0));
        ...
        jButton3.setText("Change Student Grade");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      ...
      user_id = JOptionPane.showInputDialog("Enter student ID");
      
      this.setVisible(false);
            try {
                new changegrade(user_id).setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
            ...
            this.setVisible(false);
            try {
                showgrades newmenu = new showgrades();
